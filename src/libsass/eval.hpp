...
namespace Sass {
  ...
  private:
    ...
    bool is_url_function(const sass::string& value); //LSH+
    sass::string get_uri_from_url_function(const sass::string& value); //LSH+
    sass::string wrap_uri_in_url_function(const sass::string& value); //LSH+
  };
